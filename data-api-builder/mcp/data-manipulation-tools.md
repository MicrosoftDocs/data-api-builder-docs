---
title: DML tools in SQL MCP Server
...
SQL MCP Server exposes six Data Manipulation Language (DML) tools to AI agents. These tools provide a typed CRUD surface for database operations. All tools respect role-based access control (RBAC), entity permissions, and policies defined in your configuration.
...
- [Adding semantic descriptions](descriptions.md)
- [Configuration reference](../configuration/index.md)
- [Deploy to Azure Container Apps](quickstart/azure-container-apps.md)
