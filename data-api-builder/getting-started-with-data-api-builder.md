...
- [Getting Started with Data API builder for Azure SQL](./getting-started/getting-started-azure-sql.md)
- [Getting Started with Data API builder for with Azure Cosmos DB](./getting-started/getting-started-azure-cosmos-db.md)
