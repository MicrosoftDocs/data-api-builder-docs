...
Read all the details in the [Use Application Insights](../concept/monitor/application-insights.md) documentation page.
...
For more information about the specifics of OpenAPI and Data API builder, see [OpenAPI](../concept/rest/openapi.md).
...
You can read more about this capability within the context of REST [in the REST documentation](../concept/rest/overview.md) and of GraphQL [in the GraphQL documentation](../concept/graphql/overview.md).
...
Full support for stored procedure in REST and GraphQL. Stored procedure with parameters now 100% supported. Check out the [Stored procedures](../concept/rest/stored-procedures.md) documentation to learn how to use Data API builder with stored procedures.
