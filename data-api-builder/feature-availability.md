...
| [Aggregation](concept/graphql/aggregate-data.md) | ✅ Yes | ✖️ No | ✖️ No | ✖️ No | ✅ Yes |
| [Sorting](keywords/orderby-graphql.md) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [Selection](keywords/select-graphql.md) | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes |
| [Query-type](concept/graphql/overview.md) | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes |
| [Mutation-type](concept/graphql/overview.md) | ✅ Yes | ⚠️ Partial | ✅ Yes | ✅ Yes | ✅ Yes |
| Multi-Mutation | ✅ Yes | ✖️ No | ✖️ No | ✖️ No | ✖️ No |
| Advanced GroupBy | ✅ Yes | ✖️ No | ✖️ No | ✖️ No | ✅ Yes |
| Advanced Having | ✅ Yes | ✖️ No | ✖️ No | ✖️ No | ✅ Yes |
| [Schema Generation](concept/graphql/overview.md) | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes |
...
| [Nitro](concept/graphql/overview.md) | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes |
...
| [`PATCH`](concept/rest/overview.md) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [`DELETE`](concept/rest/overview.md) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [`GET`](concept/rest/overview.md) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
...
| [OpenAPI Document](concept/rest/openapi.md) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [Swagger UI](concept/rest/openapi.md) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [Permission-aware OpenAPI](concept/rest/openapi.md#permission-aware-openapi) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [Advanced REST Paths](concept/rest/overview.md#advanced-rest-paths-with-subdirectories) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [Keyless PUT and PATCH](concept/rest/overview.md#keyless-put-and-patch-for-autogenerated-primary-keys) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [Cache Headers](concept/cache/http-headers.md) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [Level 1 Cache: Memory](concept/cache/level-1.md) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [Level 2 Cache: Redis](concept/cache/level-2.md) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
| [POCO-ready Payload](concept/rest/overview.md) | ✅ Yes | ✖️ No | ✅ Yes | ✅ Yes | ✅ Yes |
...
| [HTTP Response Compression](concept/rest/overview.md#http-response-compression) | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes |
