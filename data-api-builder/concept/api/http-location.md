...
> [!TIP]
> Starting in Data API builder 2.0, `PUT` and `PATCH` requests can omit the primary key from the URL when all key columns are autogenerated. For more information, see [keyless PUT and PATCH](./rest.md#keyless-put-and-patch-for-auto-generated-primary-keys).
