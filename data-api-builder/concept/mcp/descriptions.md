---
title: Adding descriptions to SQL MCP Server entities
description: Learn how to add semantic descriptions to tables, views, stored procedures, fields, and parameters to help AI agents better understand your data.
author: jnixon
...
### Adding descriptions with `dab add`
...
### Adding descriptions with `dab update`
...
### Adding field descriptions with `dab update`
...
### Adding multiple field descriptions
...
### Adding parameter descriptions with `dab update`
